  ...
  try {
    ...
    switch (_0x3c8344) {
      ...
      case "hidetag":
        {
          if (!grupAkses) {
            return reply("Grup ini belum di berikan akses menggunakan bot silahkan ketik .akses untuk memberikan akses grup");
          }
          if (!isGroup) {
          ...
          let teks = quotedMessage ? quotedMessage.text : args ? args : "";
          sendMessage(chatId, {
            text: teks,
